...
Technical notes and recorded experiments from the original README. For current setup instructions, see [the installation guide](install.md) or [return to the README](../README.md).
...
![learning curve](images/ogrenme_egrisi.png)
...
<img src="images/demo_uret.gif" width="520" alt="uret tas kazma resolving its own recipe tree">
...
Activate the Python environment prepared by setup before running the Python commands below. Run commands from the repository root unless a cd command says otherwise.
...
> Türkçe okuyanlar için mimari notları: [`docs/mimari.md`](mimari.md)
